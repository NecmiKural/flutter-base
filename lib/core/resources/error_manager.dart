...
// /// An enum that contains error codes that the user may encounter.
// ///
// /// ?? Note:
// ///
// /// You can use this enum to add your own error codes.
// ///
// /// When you add a new error code, you should also add the corresponding
// /// user-friendly error message to the [AppErrorText] class.
// enum Errors {
...
//     "invalid-phone-number": tr(LocaleKeys.errors_invalid_phone_number),
