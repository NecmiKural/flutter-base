...
class TextStyles {
  ...
  final TextTheme textTheme = TextTheme(
    headlineLarge: _font(color: AppColors.darkTextColors[70]),
    headlineMedium: _font(color: AppColors.darkTextColors[70]),
    headlineSmall: _font(color: AppColors.darkTextColors[70]),
    displayLarge: _font(),
    displayMedium: _font(color: AppColors.darkTextColors[70]),
    displaySmall: _font(color: AppColors.darkTextColors[70]),
    titleLarge: _font(color: AppColors.darkTextColors[70]),
    titleMedium: _font(
      color: AppColors.darkTextColors[70],
      fontWeight: FontWeight.w500,
    ),
    titleSmall: _font(color: AppColors.darkTextColors[70]),

    /// Body
    bodyLarge: _font(color: AppColors.primaryTextColor),
    bodyMedium: _font(color: AppColors.darkTextColors[70]),
    bodySmall: _font(color: AppColors.secondaryTextColor),
